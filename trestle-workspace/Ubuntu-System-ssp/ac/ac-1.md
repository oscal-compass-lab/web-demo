...
x-trestle-set-params:
  ...
  ac-01_odp.05:
    guidelines:
      - prose: the frequency at which the current access control policy is 
  ...
  ac-01_odp.07:
    guidelines:
      - prose: the frequency at which the current access control procedures are 
          reviewed and updated is defined;
    values:
      - at least annually
...
- \[AC-01c.\]
  ...
  - \[AC-01c.01\]
    ...
    - \[AC-01c.01[01]\] the current access control policy is reviewed and updated [at least every 3 years];
    - \[AC-01c.01[02]\] the current access control policy is reviewed and updated following [events];

  - \[AC-01c.02\]

    - \[AC-01c.02[01]\] the current access control procedures are reviewed and updated [at least annually];
    - \[AC-01c.02[02]\] the current access control procedures are reviewed and updated following [significant changes].
