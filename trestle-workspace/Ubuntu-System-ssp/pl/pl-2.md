...
x-trestle-set-params:
  ...
  pl-02_odp.01:
    guidelines:
      - prose: individuals or groups with whom security and privacy-related 
          activities affecting the system that require planning and coordination
          is/are assigned;
    values:
  ...
  pl-02_odp.02:
    guidelines:
      - prose: personnel or roles to receive distributed copies of the system 
          security and privacy plans is/are assigned;
    values:
...
- \[PL-02a.\]
  ...
  - \[PL-02a.14\]
    ...
    - \[PL-02a.14[01]\] a security plan for the system is developed that includes security-related activities affecting the system that require planning and coordination with [to include chief privacy and ISSO and/or similar role or designees];
    - \[PL-02a.14[02]\] a privacy plan for the system is developed that includes privacy-related activities affecting the system that require planning and coordination with [to include chief privacy and ISSO and/or similar role or designees];
...
- \[PL-02b.\]
  ...
  - \[PL-02b.[01]\] copies of the plans are distributed to [to include chief privacy and ISSO and/or similar role];
  - \[PL-02b.[02]\] subsequent changes to the plans are communicated to [to include chief privacy and ISSO and/or similar role];

- \[PL-02c.\] plans are reviewed [at least annually];
