...
x-trestle-set-params:
  ...
  pl-08_odp:
    guidelines:
      - prose: frequency for review and update to reflect changes in the 
...
- \[PL-08b.\] changes in the enterprise architecture are reviewed and updated [at least annually and when a significant change occurs] to reflect changes in the enterprise architecture;
