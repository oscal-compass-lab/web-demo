...
x-trestle-set-params:
  ...
  pl-01_odp.05:
    guidelines:
      - prose: the frequency with which the current planning policy is reviewed 
  ...
  pl-01_odp.07:
    guidelines:
      - prose: the frequency with which the current planning procedures are 
...
- \[PL-01c.\]
  ...
  - \[PL-01c.01\]
    ...
    - \[PL-01c.01[01]\] the current planning policy is reviewed and updated [at least every 3 years];
    - \[PL-01c.01[02]\] the current planning policy is reviewed and updated following [events];

  - \[PL-01c.02\]

    - \[PL-01c.02[01]\] the current planning procedures are reviewed and updated [at least annually];
    - \[PL-01c.02[02]\] the current planning procedures are reviewed and updated following [significant changes].
