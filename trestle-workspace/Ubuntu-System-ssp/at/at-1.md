...
x-trestle-set-params:
  ...
  at-01_odp.05:
    guidelines:
      - prose: the frequency at which the current awareness and training policy 
  ...
  at-01_odp.07:
    guidelines:
      - prose: the frequency at which the current awareness and training 
  ...
  at-01_odp.08:
    guidelines:
      - prose: events that would require procedures to be reviewed and updated 
          are defined;
    values:
      - significant changes
...
- \[AT-01c.\]
  ...
  - \[AT-01c.01\]
    ...
    - \[AT-01c.01[01]\] the current awareness and training policy is reviewed and updated [at least every 3 years];
    - \[AT-01c.01[02]\] the current awareness and training policy is reviewed and updated following [events];

  - \[AT-01c.02\]

    - \[AT-01c.02[01]\] the current awareness and training procedures are reviewed and updated [at least annually];
    - \[AT-01c.02[02]\] the current awareness and training procedures are reviewed and updated following [significant changes].
