...
x-trestle-set-params:
  ...
  pe-01_odp.05:
    guidelines:
      - prose: the frequency at which the current physical and environmental 
          protection policy is reviewed and updated is defined;
    values:
  ...
  pe-01_odp.07:
    guidelines:
      - prose: the frequency at which the current physical and environmental 
          protection procedures are reviewed and updated is defined;
    values:
      - at least annually
  ...
  pe-01_odp.08:
    guidelines:
      - prose: events that would require the physical and environmental 
          protection procedures to be reviewed and updated are defined;
    values:
      - significant changes
...
- \[PE-01c.\]
  ...
  - \[PE-01c.01\]
    ...
    - \[PE-01c.01[01]\] the current physical and environmental protection policy is reviewed and updated [at least every 3 years];
    - \[PE-01c.01[02]\] the current physical and environmental protection policy is reviewed and updated following [events];

  - \[PE-01c.02\]

    - \[PE-01c.02[01]\] the current physical and environmental protection procedures are reviewed and updated [at least annually];
    - \[PE-01c.02[02]\] the current physical and environmental protection procedures are reviewed and updated following [significant changes].
