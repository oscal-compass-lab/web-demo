...
x-trestle-set-params:
  ...
  cm-07.05_odp.02:
    guidelines:
      - prose: frequency at which to review and update the list of authorized 
...
- \[(c)\] Review and update the list of authorized software programs [at least quarterly or when there is a change].

## Control Assessment Objective

- \[CM-07(05)(a)\] [software programs] are identified;
...
- \[CM-07(05)(c)\] the list of authorized software programs is reviewed and updated [at least quarterly or when there is a change].
