...
x-trestle-set-params:
  ...
  cm-02_odp.01:
    guidelines:
      - prose: the frequency of baseline configuration review and update is 
          defined;
    values:
...
- \[CM-02b.\]
  ...
  - \[CM-02b.01\] the baseline configuration of the system is reviewed and updated [at least annually and when a significant change occurs];
