...
x-trestle-set-params:
  ...
  ca-08_odp.01:
    guidelines:
      - prose: frequency at which to conduct penetration testing on systems or 
          system components is defined;
    values:
      - at least annually
...
Conduct penetration testing [at least annually] on [system(s) or system components].

## Control Assessment Objective

penetration testing is conducted [at least annually] on [system(s) or system components].
