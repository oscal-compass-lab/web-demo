...
x-trestle-set-params:
  ...
  ra-01_odp.05:
    guidelines:
      - prose: the frequency at which the current risk assessment policy is 
  ...
  ra-01_odp.07:
    guidelines:
      - prose: the frequency at which the current risk assessment procedures are
          reviewed and updated is defined;
    values:
      - at least annually
  ...
  ra-01_odp.08:
    guidelines:
      - prose: events that would require risk assessment procedures to be 
...
- \[RA-01c.\]
  ...
  - \[RA-01c.01\]
    ...
    - \[RA-01c.01[01]\] the current risk assessment policy is reviewed and updated [at least every 3 years];
    - \[RA-01c.01[02]\] the current risk assessment policy is reviewed and updated following [events];

  - \[RA-01c.02\]

    - \[RA-01c.02[01]\] the current risk assessment procedures are reviewed and updated [at least annually];
    - \[RA-01c.02[02]\] the current risk assessment procedures are reviewed and updated following [significant changes].
