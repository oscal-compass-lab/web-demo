...
x-trestle-set-params:
  ...
  ac-02_odp.06:
    guidelines:
      - prose: time period within which to notify account managers when accounts
          are no longer required is defined;
    values:
  ...
  ac-02_odp.08:
    guidelines:
      - prose: time period within which to notify account managers when system 
          usage or the need to know changes for an individual is defined;
    values:
      - eight (8) hours
...
- \[AC-02h.\]
  ...
  - \[AC-02h.01\] account managers and [personnel or roles] are notified within [twenty-four (24) hours] when accounts are no longer required;
  - \[AC-02h.02\] account managers and [personnel or roles] are notified within [eight (8) hours] when users are terminated or transferred;
  - \[AC-02h.03\] account managers and [personnel or roles] are notified within [eight (8) hours] when system usage or the need to know changes for an individual;
...
- \[AC-02j.\] accounts are reviewed for compliance with account management requirements [quarterly for privileged access, annually for non-privileged access];
