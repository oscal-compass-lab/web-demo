...
x-trestle-set-params:
  ...
  ac-02.05_odp:
    guidelines:
      - prose: the time period of expected inactivity or description of when to 
          log out is defined;
    values:
...
users are required to log out when [for privileged users, it is the end of a user's standard work period].
