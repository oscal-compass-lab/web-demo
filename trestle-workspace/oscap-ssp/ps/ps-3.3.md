...
x-trestle-set-params:
  ...
  ps-03.03_odp:
    guidelines:
      - prose: additional personnel screening criteria to be satisfied for 
          individuals accessing a system processing, storing, or transmitting 
          information requiring special protection are defined;
    values:
...
- \[PS-03(03)(b)\] individuals accessing a system processing, storing, or transmitting information requiring special protection satisfy [personnel screening criteria – as required by specific information].
