...
x-trestle-set-params:
  ...
  cp-01_odp.05:
    guidelines:
      - prose: the frequency at which the current contingency planning policy is
  ...
  cp-01_odp.07:
    guidelines:
      - prose: the frequency at which the current contingency planning 
...
- \[CP-01c.\]
  ...
  - \[CP-01c.01\]
    ...
    - \[CP-01c.01[01]\] the current contingency planning policy is reviewed and updated [at least every 3 years];
    - \[CP-01c.01[02]\] the current contingency planning policy is reviewed and updated following [events];

  - \[CP-01c.02\]

    - \[CP-01c.02[01]\] the current contingency planning procedures are reviewed and updated [at least annually];
    - \[CP-01c.02[02]\] the current contingency planning procedures are reviewed and updated following [significant changes].
