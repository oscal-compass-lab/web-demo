...
x-trestle-set-params:
  ...
  sc-07.04_odp:
    guidelines:
      - prose: the frequency at which to review exceptions to traffic flow 
          policy is defined;
    values:
      - at least every 180 days or whenever there is a change in the threat 
        environment that warrants a review of the exceptions
...
- \[SC-07(04)(e)\]
  ...
  - \[SC-07(04)(e)[01]\] exceptions to the traffic flow policy are reviewed [at least every 180 days or whenever there is a change in the threat environment that warrants a review of the exceptions];
