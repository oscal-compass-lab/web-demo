...
x-trestle-set-params:
  ...
  sc-12_odp:
    guidelines:
      - prose: requirements for key generation, distribution, storage, access, 
...
- \[SC-12[01]\] cryptographic keys are established when cryptography is employed within the system in accordance with [In accordance with Federal requirements];

- \[SC-12[02]\] cryptographic keys are managed when cryptography is employed within the system in accordance with [In accordance with Federal requirements].
