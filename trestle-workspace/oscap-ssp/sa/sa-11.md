...
- \[b.\] Perform [Selection (one or more): unit; integration; system; regression] testing/evaluation [frequency to conduct] at [depth and coverage];
...
- \[SA-11b.\] the developer of the system, system component, or system service is required at all post-design stages of the system development life cycle to perform [Selection (one or more): unit; integration; system; regression] testing/evaluation [frequency to conduct] at [depth and coverage];
