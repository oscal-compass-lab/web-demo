...
x-trestle-set-params:
  ...
  sr-01_odp.05:
    guidelines:
      - prose: the frequency at which the current supply chain risk management 
  ...
  sr-01_odp.07:
    guidelines:
      - prose: the frequency at which the current supply chain risk management 
          procedure is reviewed and updated is defined;
    values:
      - at least annually
  ...
  sr-01_odp.08:
    guidelines:
      - prose: events that require the supply chain risk management procedures 
...
- \[SR-01c.\]
  ...
  - \[SR-01c.01\]
    ...
    - \[SR-01c.01[01]\] the current supply chain risk management policy is reviewed and updated [at least every 3 years];
    - \[SR-01c.01[02]\] the current supply chain risk management policy is reviewed and updated following [events];

  - \[SR-01c.02\]

    - \[SR-01c.02[01]\] the current supply chain risk management procedures are reviewed and updated [at least annually];
    - \[SR-01c.02[02]\] the current supply chain risk management procedures are reviewed and updated following [significant changes].
