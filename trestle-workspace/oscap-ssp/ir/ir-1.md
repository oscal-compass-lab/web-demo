...
x-trestle-set-params:
  ...
  ir-01_odp.05:
    guidelines:
      - prose: the frequency at which the current incident response policy is 
  ...
  ir-01_odp.07:
    guidelines:
      - prose: the frequency at which the current incident response procedures 
  ...
  ir-01_odp.08:
    guidelines:
      - prose: events that would require the incident response procedures to be 
...
- \[IR-01c.\]
  ...
  - \[IR-01c.01\]
    ...
    - \[IR-01c.01[01]\] the current incident response policy is reviewed and updated [at least every 3 years];
    - \[IR-01c.01[02]\] the current incident response policy is reviewed and updated following [events];

  - \[IR-01c.02\]

    - \[IR-01c.02[01]\] the current incident response procedures are reviewed and updated [at least annually];
    - \[IR-01c.02[02]\] the current incident response procedures are reviewed and updated following [significant changes].
